export const QuizGame = [
  {
    ...
    quizz: {
      beginner: [
        {
          id: 0,
          question:
            "At the start of a chess game, how many pieces are there in total on a chess board?",
          options: ["8", "16", "32", "30"],
          answer: "32",
          heroId: 1009362,
        },
        ...
        },
        {
          ...
          options: ["King", "Queen", "Knight", "Parker"],
          answer: "Queen",
          heroId: 1009610,
        },
        {
          ...
          options: ["Bishop", "Death", "Pawn", "Rook", "King"],
          answer: "Pawn",
          heroId: 1009718,
        },
        {
          id: 4,
          question:
            "Who was generally recognised to be the first World Chess Champion in 1886?",
          options: [
            "Wilhelm Steinitz",
            "Stefan Leibniz",
            " Franck Venom",
        ...
        },
        {
          id: 6,
          question:
            "Quel super-héros ressemble à un être de pierre, needing his name?",
        ...
        {
          id: 7,
          question: "In Marvel game,From whom Edwin Jarvis is majordome?",
          options: [
            "Bruce Wayne",
            "Charles Xavier",
            "Tony Stark",
        ...
        },
        {
          ...
          options: ["India", "China", "England", "Italy"],
          answer: "India",
          heroId: 1009220,
        },
        {
          id: 9,
          question:
            "Which piece can only move one square to any side in each move?",
          options: ["pawn", "King", "Knight"],
          answer: "King",
          heroId: 1009662,
        },
      ],
      middle: [
        {
          id: 0,
          question: "who is Logan in  Marvel Comics 'X-Men' ?",
        ...
        {
          id: 1,
          question: "Which super hiro is interesed by Sue Storm?",
        ...
        },
        {
          id: 2,
          question:
            "English to French: Quel humain devient surpuissant grâce à une armure de haute technologie ?",
